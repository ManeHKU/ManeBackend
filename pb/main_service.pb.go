...
var file_main_service_proto_rawDesc = []byte{
	...
	0x55, 0x52, 0x4c, 0x73, 0x32, 0x81, 0x06, 0x0a, 0x0b, 0x4d, 0x61, 0x69, 0x6e, 0x53, 0x65, 0x72,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x0c, 0x5a, 0x0a, 0x73, 0x65, 0x72, 0x76,
...
var file_main_service_proto_goTypes = []interface{}{
	...
	(*AddReviewResponse)(nil),               // 20: reviews.AddReviewResponse
	(*ListLatestEventsResponse)(nil),        // 21: events.ListLatestEventsResponse
	(*AddEventResponse)(nil),                // 22: events.AddEventResponse
	(*ApplyEventResponse)(nil),              // 23: events.ApplyEventResponse
}
var file_main_service_proto_depIdxs = []int32{
	...
	8,  // 18: service.MainService.GetUpdatedURLs:output_type -> service.GetUpdatedURLsResponse
	19, // 19: service.MainService.UpdateUserInfo:output_type -> google.protobuf.Empty
	19, // 20: service.MainService.UpsertTakenCourses:output_type -> google.protobuf.Empty
	2,  // 21: service.MainService.ListCourses:output_type -> service.CoursesResponse
	2,  // 22: service.MainService.SearchCourses:output_type -> service.CoursesResponse
	4,  // 23: service.MainService.GetCourseDetails:output_type -> service.GetCourseDetailResponse
	20, // 24: service.MainService.AddReview:output_type -> reviews.AddReviewResponse
	21, // 25: service.MainService.ListLatestEvents:output_type -> events.ListLatestEventsResponse
	22, // 26: service.MainService.AddEvent:output_type -> events.AddEventResponse
	23, // 27: service.MainService.ApplyEvent:output_type -> events.ApplyEventResponse
